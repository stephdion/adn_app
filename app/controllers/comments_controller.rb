class CommentsController < ApplicationController
  ...
  before_filter :comments_permissions, :except => [:new]
  ...
  private
    ...
    def comment_params
      params.require(:comment).permit(:nom, :email, :other, :prenom, :telephone,
                                      :user_type, :organization, :archive, :receive_news)
    end

    def comments_permissions
